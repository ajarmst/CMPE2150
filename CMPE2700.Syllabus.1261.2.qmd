...
+------------+--------------+--------------------------------+----------------------------------------------------+--------------+
| Semester   | Sections     | Instructor                     | Contact                                            | Office       |
+============+==============+================================+====================================================+==============+
| Fall 2026  | A01,A02      | AJ Armstrong                   | [aja\@nait.ca](mailto://aja@nait.ca "aja@nait.ca") | WC204        |
+------------+--------------+--------------------------------+----------------------------------------------------+--------------+
: {tbl-colwidths="[15,15,30,20,20]"}
...
As it is a course focusing on practical skills, evaluation in CMPE2700 will be via practical exercises (Labs and Projects) which are designed to let you explore the concepts that are discussed in class and develop your understanding with hands-on practice.
...
+-------------------------------+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------+
| Lab Exercises                 | 40%                | One per topic. Checked-off in class by your instructor.                                                                                                 |
+-------------------------------+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------+---------------------------------------------------+--------------------------------------------+
| 11     | Industrial Comms & TCP/IP                         | *Lose one day to Fall Break*               |
|        |                                                   |                                            |
|        |                                                   | A10: Industrial Protocols and TCP/IP       |
+--------+---------------------------------------------------+--------------------------------------------+
| 12     | Industrial Comms & TCP/IP                         | **P04: Wireshark**                         |
+--------+---------------------------------------------------+--------------------------------------------+
